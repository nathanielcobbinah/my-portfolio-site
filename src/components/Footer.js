...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-blue-950 to-black h-full bg-no-repeat text-white py-8">
      <div className="container mx-auto text-center">
        <p className="text-sm">&copy; 2024 Nathaniel de Escade. All rights reserved.</p>
